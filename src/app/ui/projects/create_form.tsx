...
import { Bean, Partner } from "@/app/lib/definitions";
import MultiSelect from "./multiple_Select";
import { createProject } from "@/app/lib/actions";


export default function Form({ beans, partners }: { beans: Bean[], partners: Partner[] }) {

    return (
        <form className="" action={createProject}>
